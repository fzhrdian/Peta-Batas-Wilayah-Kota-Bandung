...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [781989.824960, 9226959.356547, 802413.552571, 9244477.984972], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32748',
...
map.getView().fit([781989.824960, 9226959.356547, 802413.552571, 9244477.984972], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA BATAS WILAYAH KOTA BANDUNG</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (57 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Batas Wilayah ini berisi batas Kecamatan di Kota Bandung.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Kota_BandungADMNew_1,
    colName: 'NAMOBJ',
    zoom: 10,
    collapsed: true,
    map: map,
